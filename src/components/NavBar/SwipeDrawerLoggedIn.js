...
import photo from "./photos/profilepic.jpg";
...
export default function SwipeDrawerLoggedIn(props) {
    ...
    >
      ...
      <div className="w-50 mx-auto">
        <Image
          ...
          width="95"
        />
        <h4 className="text-primary mb-1">Jane Doe</h4>
      </div>
      <Divider />
      <List>
        <Tabs
        ...
        >
          ...
          <Tab
            ...
            {...a11yProps(7)}
          />
          <NavLink to="/" className="text-decoration-none mx-auto">
            <Tab
              icon={
                <div>
                  ...
                  <Col>
                    <Row>
                      ...
                      <TabPanel value={value2} index={0}>
                        <Posts viewpost="viewpostloggedin" />
                      </TabPanel>
